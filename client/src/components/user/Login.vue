          ...
          <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center rounded-lg auth-h100">
              <div style="max-width: 25rem;">
                  <div class="text-center mb-4">
                      <svg xmlns="http://www.w3.org/2000/svg" width="60" viewBox="0 0 64 80" fill="none">
                  ...
                  <div class="mb-5 text-center">
                      <h1 class="color-900">Happy House</h1>
                  </div>
              </div>
          </div>
              ...
              <div class="w-100 p-4 p-md-5 card border-0" style="max-width: 32rem;">
                  ...
                  <form class="row g-1 p-0 p-md-4">
                      ...
                      <div class="col-12 text-center mt-4">
                          <a href="index.html" class="btn btn-lg btn-block btn-dark lift text-uppercase">login</a>
                      </div>
                      <div class="col-12 text-center mt-4">
                          <span class="text-muted">회원가입 시 다양한 주거지 실거래가 정보를 제공합니다! <a href="auth-signup.html">join us</a></span>
                      </div>
                  </form>
                  <!-- End Form -->
              </div>
