      ...
      <form class="row g-1 p-0 p-md-4">
        ...
        <div class="col-12">
          <div class="mb-2">
            ...
            <input type="name" class="form-control" placeholder="이름을 입력하세요." />
          </div>
        </div>
        <div class="col-12">
          <div class="mb-2">
            <label class="form-label">아이디</label>
            <input type="id" class="form-control" placeholder="아이디를 입력하세요." />
          </div>
        </div>
        <div class="col-12">
          <div class="mb-2">
            <label class="form-label">이메일</label>
            <input type="email" class="form-control" placeholder="아이디를 입력하세요." />
          </div>
        </div>
        <div class="col-12">
          <div class="mb-2">
        ...
        <div class="col-12 text-center mt-4">
          <a href="index.html" class="btn btn-dark lift text-uppercase">join us</a>
        </div>
        <div class="col-12 text-center mt-4">
