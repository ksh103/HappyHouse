...
public class WebConfiguration implements WebMvcConfigurer{
    ...
    public void addInterceptors(InterceptorRegistry registry) {
    	...
    	.excludePathPatterns("/user/login", "/user/logout", "/user/password", "/user/join")		// 로그인, 로그아웃 허용
    	.excludePathPatterns("/company/login", "/company/logout", "/company/password") // 로그인, 로그아웃 허용
